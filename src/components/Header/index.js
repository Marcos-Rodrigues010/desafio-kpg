...
const Container = () => {
    ...
    function toglleBackground() {
        setPositionWindow(window.pageYOffset);
        if (positionWindow <= 100) {
            area.current.style.background = "transparent";
            document.querySelector("#c6bank").setAttribute("fill", '#FFF');
            document.querySelector("#forYou").style.color = "#FFF";
            document.querySelector("#forYourCompany").style.color = "#FFF";
            document.querySelector("#arrow1").setAttribute("fill", '#FFF');
            document.querySelector("#arrow2").setAttribute("fill", '#FFF');
            document.querySelector('#signUp--btn').classList.remove("black-btn");
            document.querySelector('#signUp--btn').classList.add("white-btn");
        } else if (positionWindow > 100) {
            area.current.style.background = "#FFF";
            document.querySelector("#c6bank").setAttribute("fill", '#000');
            document.querySelector('#signUp--btn').classList.remove("white-btn");
            document.querySelector('#signUp--btn').classList.add("black-btn");
            if(window.screen.width <= 600){     
                ...
                document.querySelector("#forYou").style.color = "#000";
                document.querySelector("#forYourCompany").style.color = "#000";
                document.querySelector("#arrow1").setAttribute("fill", '#000');
                document.querySelector("#arrow2").setAttribute("fill", '#000');
            };
        }
    }

    window.addEventListener('scroll', toglleBackground);

    function toggleMenu() {
        setVisibleMenu(!visibleMenu);
        if(visibleMenu){
            document.querySelector('.business').style.display = 'flex';
        }else{
        ...
        <Header ref={area}>
            <div className="header--container">
                ...
                <nav className="business" id="business">
                    ...
                    <div className="dropdown" id="forYourCompany">
                        <span>Para seu negócio</span>
                        <svg width='18px' height='12px' version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129" xmlnsXlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 129 129">
                            <g>
                                <path id="arrow2" d="m150.3,45.6c-1.6-1.6-4.2-1.6-5.8,0l-51,51.1-51.1-51.1c-1.6-1.6-4.2-1.6-5.8,0-1.6,1.6-1.6,4.2 0,5.8l53.9,53.9c0.8,0.8 1.8,1.2 2.9,1.2 1,0 2.1-0.4 2.9-1.2l53.9-53.9c1.7-1.6 1.7-4.2 0.1-5.8z" fill="#FFF" />
                            </g>
                        </svg>
                        <div className="dropdown--content">
                            <ul>
                ...
                <div className="btn white-btn" id="signUp--btn">ABRA SUA CONTA</div>
                <div className="menu-icon">
                    <svg version="1.1" id="menu-button" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        width="24px" height="24px" viewBox="0 0 612 612" style={{enableBackground:'new 0 0 612 612'}} xmlSpace="preserve" onClick={toggleMenu}>
                        <g>
                            <g>
                                <path fill="#FDC027" d="M604.267,194.727c4.257,0,7.733-3.644,7.733-7.733v-40.169c0-4.256-3.283-7.733-7.733-7.733H7.733
			c-4.256,0-7.733,3.644-7.733,7.733v40.169c0,4.256,3.283,7.733,7.733,7.733H604.267z"/>
                                <path fill="#FDC027" d="M0,326.084c0,4.256,3.283,7.733,7.733,7.733h596.533c4.256,0,7.733-3.645,7.733-7.733v-40.169
			c0-4.284-3.283-7.733-7.733-7.733H7.733c-4.256,0-7.733,3.645-7.733,7.733V326.084z"/>
                                <path fill="#FDC027" d="M0,465.175c0,4.256,3.283,7.733,7.733,7.733h596.533c4.256,0,7.733-3.645,7.733-7.733v-40.169
